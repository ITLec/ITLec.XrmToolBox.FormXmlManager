    ...
    public partial class FormXmlEditorHelper : Form
    {
      ...
      //  private
        ...
        private void TvSiteMapNodeMouseClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            var collec = (Dictionary<string, ITLec.CRMFormXmlGuy.Property>)selectedNode.Tag;
        ...
        private void AddXmlNode(TreeNode currentNode, XmlNode parentXmlNode, bool hasDisabledParent = false)
        {
            ...
            var collec = (Dictionary<string, ITLec.CRMFormXmlGuy.Property>)currentNode.Tag;
            if (collec != null)
            {
        ...
        private void AppendCustomProperties(XmlNode parentXmlNode, Dictionary<string, ITLec.CRMFormXmlGuy.Property> collec)
        {
